...
document.body.querySelector('#triggerAni').addEventListener('click', function(event){
  document.body.querySelector('#imgdiv').classList.add('rt');
});

document.body.querySelector('#triggerRestore').addEventListener('click', function(event){
  document.body.querySelector('#imgdiv').classList.remove('rt');
});